...
- rough ETA
- latest-frame preview sourced from `Saved: '<path>'` lines
...
- latest-frame detail-panel preview for saved renders
...
- the detail panel now shows the last saved render frame for PNG, EXR, JPEG, and TIFF outputs
